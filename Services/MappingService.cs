...
namespace GamepadEmulator.Services
{
    ...
    {
        private Dictionary<int, Xbox360Button> _keyToButton = new Dictionary<int, Xbox360Button>
        {
        ...
        private Dictionary<int, Tuple<int, double>> _movementKeys = new Dictionary<int, Tuple<int, double>>
        {
        ...
        // Properties to access the current mappings
        public Dictionary<int, Xbox360Button> KeyToButtonMapping => _keyToButton;
        public Dictionary<int, Tuple<int, double>> MovementKeyMapping => _movementKeys;
        ...
        // Method to update key to button mapping
        public void UpdateKeyToButtonMapping(int keyCode, Xbox360Button button)
        {
            _keyToButton[keyCode] = button;
        }

        // Method to update movement key mapping
        public void UpdateMovementKeyMapping(int keyCode, int axis, double direction)
        {
            _movementKeys[keyCode] = new Tuple<int, double>(axis, direction);
        }

        // Method to remove a key mapping
        public void RemoveKeyMapping(int keyCode)
        {
            _keyToButton.Remove(keyCode);
            _movementKeys.Remove(keyCode);
        }
